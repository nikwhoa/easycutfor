...
// 	}
	...
	function cartLoop3() {
		if (document.getElementsByClassName('woocommerce-mini-cart__buttons buttons')[0]) {
			if (document.getElementsByClassName('button wc-forward')[0].innerHTML !== 'View Cart'){document.getElementsByClassName('button wc-forward')[0].innerHTML = 'View Cart'; document.getElementsByClassName('button wc-forward')[0].setAttribute('href', '/en/cart/');}
			if (document.getElementsByClassName('button checkout wc-forward')[0].innerHTML !== 'Checkout'){document.getElementsByClassName('button checkout wc-forward')[0].innerHTML = 'Checkout'; document.getElementsByClassName('button checkout wc-forward')[0].setAttribute('href', '/en/checkout/');}
